<?php
  require 'dbh/dbh.php'; 
  session_start();
//  if ($_SESSION['Department'] !== 'SUPPORT')
//  {
...
<html lang="en">
  ...
  <body class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        <li><a class="app-menu__item" href="Support.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Home</span></a></li>
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label">New</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="#staff" data-toggle="modal"><i class="icon fa fa-circle-o"></i>Document</a></li>
            <!-- <li><a class="treeview-item" href="#staff" data-toggle="modal"><i class="icon fa fa-circle-o"></i>Document</a></li> -->
          </ul>
        </li>
        <li><a class="app-menu__item" href="#"><i class="app-menu__icon fa fa-edit"></i><span class="app-menu__label">PROJECTS</span></a></li>
        <li><a class="app-menu__item" href="#"><i class="app-menu__icon fa fa-money"></i><span class="app-menu__label">FINANCIAL STATEMENTS</span></a></li>
        <li><a class="app-menu__item" href="#"><i class="app-menu__icon fa fa-file"></i><span class="app-menu__label">PROCUREMENTS</span></a></li>
         <!-- <li><a class="app-menu__item" href="#"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">PROJECTS</span></a></li>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="tile">
                <div class="tile-body">
                  <?php
                  $sql = "SELECT DISTINCT REF_NUM,Title,Description,Type FROM Projects,Projects_budgets WHERE projects.Project_id = projects_budgets.Project_id AND Status = 'PENDING'";
                  ...
                  if($confirm > 0)
                  {
                    ...
                    {
                      echo 
                      "<b>"."Project ID: "."</b>".$row['REF_NUM']."<BR>".
                      "<b>"."Title: "."</b>".$row['Title']."<BR>".
                      "<b>"."Description: ".".</b>".$row['Description']."<BR>".
                      "<b>"."Type"."</b>".$row['Type']."<hr>";
                      echo 
                      "<div class='row'>".
                      "<div class='col-md-12'>".
                      "<div class='tile'>".
                        ...
                        "<table class='table table-hover'>".
                          ...
                          "</thead>".
                          "<tbody>";
                            $sql1 = "SELECT projects.Project_id,Budget_id,Resource,Estimated_cost FROM projects,projects_budgets WHERE projects.Project_id = projects_budgets.Project_id AND Status = 'PENDING'";
                            ...
                            if($confirm1 > 0)
                            {
                              ...
                              {
                                $name = "name".$i;
                                $value = $row1['Budget_id'];
                                $Project_id = $row1['Project_id'];
                                echo 
                                "<tr>".
                                  "<td>".$row1['Resource']."</td>".
                                  "<td>".$row1['Estimated_cost']."</td>".
                                  "<td>"."<input type = 'checkbox' class = 'form-control' name = '$name' value = $value>"."</td>".
                                "</tr>";
                                $i = $i + 1;
                              }
                              echo "<input type = 'hidden' name='times' value='$i' >";
                              echo "<input type = 'hidden' name='pid' value='$Project_id'>";
                            }
